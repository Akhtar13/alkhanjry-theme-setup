            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="#" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{asset('assets/images/branding/logo.jpg')}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset('assets/images/branding/logo.jpg')}}" alt="" height="17">
                        </span>
                    </a>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{asset('assets/images/branding/logo.jpg')}}"
                                 alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        @if(auth()->guard('admin')->user()->user_type === 'agent')
                            @php
                                $userAgent = \App\Models\UserAgent::where('user_id',auth()->guard('admin')->user()->id)->first();
                            @endphp
                            <a class="dropdown-item" href="javascript:0">
                                <i class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i>
                                <span
                                    class="align-middle">Balance : <b>{{$userAgent->currency}} {{$userAgent->agent_credit ?? 0.00}}</b></span>
                            </a>
                            <div class="dropdown-divider"></div>
                        @endif

                        <a class="dropdown-item" href="{{route('admin.my-profile')}}"><i
                                class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">{{trans('messages.profile')}}</span></a>
                        <a class="dropdown-item" href="{{route('admin.change-password')}}"><i
                                class="mdi mdi-key text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">{{trans('messages.change_password')}}</span></a>
